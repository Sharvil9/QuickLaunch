...
const defaultLinks: Link[] = [
  {
    ...
    icon: 'https://workspace.google.com/static/img/workspace-logo.svg',
    subLinks: googleApps
  },
  {
    id: 'microsoft365',
  ...
  },
  {
    ...
    category: 'Productivity',
    icon: 'https://www.wolframalpha.com/_next/static/images/wolfram-alpha-logo_6XLh1tbc.svg'
  },
  {
    id: 'slack',
    title: 'Slack',
  ...
  },
  {
    ...
    category: 'AI Applications',
    icon: 'https://chat.deepseek.com/logo.svg'
  },
  {
    id: 'groq',
    title: 'Groq',
    url: 'https://groq.com',
    category: 'AI Applications',
    icon: 'https://groq.com/images/groq-logo.svg'
  },
  {
    id: 'meta-ai',
    title: 'Meta AI',
    ...
    category: 'AI Applications',
    icon: 'https://about.meta.com/brand/resources/meta/logo-social.png'
  },
  {
    id: 'firefly',
    title: 'Adobe Firefly',
  ...
  },
  {
    ...
    category: 'Social Media',
    icon: 'https://static.cdninstagram.com/rsrc.php/v3/yZ/r/bQ_q_fxhA_2.png'
  },
  {
    id: 'youtube',
    title: 'YouTube',
...
function App() {
  ...
  const handleLinkClick = (link: Link) => {
    if (link.subLinks) {
      ...
      // Only add to recent if not already in defaultLinks
      if (!defaultLinks.some(defaultLink => defaultLink.id === link.id)) {
      ...
      <div className={`h-full ${darkMode ? 'dark' : ''}`}>
        <div className={`h-full flex flex-col ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
          ...
          <button
            ...
            className="absolute bottom-4 right-4 p-2 rounded-full bg-blue-500 text-white hover:bg-blue-600 shadow-lg"
          >
